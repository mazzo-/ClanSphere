...
if(isset($_POST['agree'])) {
  ...
  $cells = ['threads_last_time','threads_last_user'];

  if(empty($update_last['comments_time']))
    $saves = [(int) $cs_thread['threads_time'], (int) $cs_thread['users_id']];
  else
    $saves = [(int) $update_last['comments_time'], (int) $update_last['users_id']];
