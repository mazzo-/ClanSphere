...
if(!empty($error) OR !isset($_POST['submit'])) {
  ...
  $report_cells = ['threads_id', 'comments_id', 'users_id', 'boardreport_time', 'boardreport_text'];
  $report_save = [$tid, $cid, $account['users_id'], cs_time(), $report];
  ...
  notifymods_mail('board', $account['users_id'], [$users_nick['users_nick'], $cs_thread['threads_headline'], $report]);
