...
if(isset($_POST['agree'])) {
  $cs_board['change_threads'] = $_POST['change_threads'] ?? 0;
  $cs_board['board_id'] = $_POST['board_id'] ?? 0;
  ...
  for($run = 0; $run < $threads_loop; $run++) {
    ...
    // cs_sql_query(__FILE__,$query);
    cs_sql_update(__FILE__, 'threads', ['board_id'], [$cs_board_id], 0, 'board_id = '.$board_id);
