...
if(isset($_POST['close'])) {
  $thread_cells = ['threads_close'];
  $thread_save = [$account['users_id']];
  ...
  $thread_cells = ['threads_important'];
  $thread_save = [1];
...
//  echo $thread_closed;
  ...
  $thread_cells = ['board_id','threads_close'];
  $thread_save = [$board_new_id,$thread_closed];
  ...
  $thread_cells = ['threads_headline'];
  $thread_save = [$thread_headline];
  $update_board = 1;
