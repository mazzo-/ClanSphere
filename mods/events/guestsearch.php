...
$guests_url = rawurlencode(str_replace(['/', '&', '\\'], '', $guests_search));
...
$search_fields = ['usr.users_nick', 'usr.users_name', 'usr.users_surname',
                       'egt.eventguests_name', 'egt.eventguests_surname', ];
$search_terms = (strlen($guests_search) > 2) ? explode(' ', $guests_search) : [];
