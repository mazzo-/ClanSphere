...
$now = cs_time();
$awards_year = $_POST['datum_year'] ?? cs_date('unix', $now, 0, 1, 'Y');
$awards_month = $_POST['datum_month'] ?? cs_date('unix', $now, 0, 1, 'm');
$awards_day = $_POST['datum_day'] ?? cs_date('unix', $now, 0, 1, 'd');
