...
$data['squad']['clans_tag'] ??= '';
$data['squad']['clans_tagpos'] ??= '';
...
$data['ranks'] = !empty($ranks) ? $ranks : [0 => ''];
...
if(!empty($account['access_awards'])) {
  ...
  $medals = [1 => 'gold', 2 => 'silber', 3 => 'bronze'];
...
$data['awards'] = !empty($awards) ? $awards : [0 => ''];
