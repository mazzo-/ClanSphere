...
if(!empty($error) OR !isset($_POST['submit'])) {
 ...
 echo cs_subtemplate(__FILE__, $data, 'users', 'create');
  ...
  if(!empty($conv_joinus) AND !empty($users_id)) {
    $array_keys = ['users_name', 'users_surname', 'users_age', 'users_place', 'users_icq', 'users_jabber', 'users_pwd'];
    $array_values = [$create['users_name'], $create['users_surname'], $create['users_age'], $create['users_place'], $create['users_icq'], $create['users_jabber'], $create['users_pwd']];
