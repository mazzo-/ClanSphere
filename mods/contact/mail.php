...
if(!empty($error) OR !isset($_POST['submit'])) {
  ...
  $mail_cells = ['mail_name','mail_time','mail_ip','mail_email','mail_icq','mail_jabber','mail_firm','categories_id','mail_subject','mail_message'];
  $mail_save = [$mail['name'],cs_time(),$ip,$mail['email'],$mail['icq'],$mail['jabber'],$mail['firm'],$mail['categories_id'],$mail['why'],$mail['text']];
