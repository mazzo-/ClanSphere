...
if(isset($_POST['submit']))
{
  ...
  {
    $vote_form = 0;
    $vote_cells = ['users_id','votes_access','votes_time','votes_question','votes_election','votes_start','votes_end','votes_close','votes_several'];
    $vote_save = [$vote_userid,$votes_access,$time,$votes_question,$votes_election,$votes_start,$votes_end,$votes_close,$votes_several];
...
if(!empty($vote_form))
{
  ...
  {
    $num = $run+1;
    $cs_votes["votes_election_$num"] = $_POST["votes_election_$num"] ?? '';
