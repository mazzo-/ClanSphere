...
if(empty($error))
{
  if($messages_users_id == $users_id)
  {
    ...
    $messages_cells = ['messages_show_sender','messages_archiv_sender'];
    $messages_content = [$messages_show_sender,$messages_archiv_sender];
  ...
  if($messages_users_id_2 == $users_id)
  {
    ...
    $messages_cells = ['messages_show_receiver','messages_archiv_receiver'];
    $messages_content = [$messages_show_receiver,$messages_archiv_receiver];
    cs_sql_update(__FILE__, 'messages', $messages_cells, $messages_content, $messages_id);
  }
