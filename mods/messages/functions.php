...
function cs_time_array() {
  ...
  $messages_data =  [
  0 => ['messages_id' => '1', 'messages_time' => $last_day, 'messages_name' => $cs_lang['last_day']],
  1 => ['messages_id' => '2', 'messages_time' => $last_2_days, 'messages_name' => $cs_lang['last_2days']],
  2 => ['messages_id' => '3', 'messages_time' => $last_4_days, 'messages_name' => $cs_lang['last_4days']],
  3 => ['messages_id' => '4', 'messages_time' => $last_7_days, 'messages_name' => $cs_lang['last_week']],
  4 => ['messages_id' => '5', 'messages_time' => $last_14_days, 'messages_name' => $cs_lang['last_2weeks']],
  5 => ['messages_id' => '6', 'messages_time' => $last_21_days, 'messages_name' => $cs_lang['last_3weeks']],
  6 => ['messages_id' => '7', 'messages_time' => $last_50_days, 'messages_name' => $cs_lang['last_50days']],
  7 => ['messages_id' => '8', 'messages_time' => $last_100_days, 'messages_name' => $cs_lang['last_100days']],
  8 => ['messages_id' => '9', 'messages_time' => $last_365_days, 'messages_name' => $cs_lang['last_year']],
  9 => ['messages_id' => '10', 'messages_time' => $last_730_days, 'messages_name' => $cs_lang['last_2years']], ];
