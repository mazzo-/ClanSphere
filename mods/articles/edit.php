...
if(isset($_POST['submit']) OR isset($_POST['preview'])) {
  ...
  $cs_articles['articles_com'] = $_POST['articles_com'] ?? 0;
  $cs_articles['articles_navlist'] = $_POST['articles_navlist'] ?? 0;
  $cs_articles['articles_fornext'] = $_POST['articles_fornext'] ?? 0;
